...
class Hedgehog extends StatefulWidget {
  @override
  _HedgehogState createState() => _HedgehogState();
}

class _HedgehogState extends State<Hedgehog> {
  void playSound(){
    final player = AudioCache();
    player.play("Hedgehog.wav");
  }
  @override
          ...
          child: Column(
            children: <Widget>[
              ...
              Row(
                ...
                children: <Widget>[
                  walkPages(Icons.arrow_back, Bear()),
                  SizedBox(width: 30,),
